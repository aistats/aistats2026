...
Authors of accepted AISTATS 2026 papers who are unable to complete their camera-ready submissions on time due to such circumstances are encouraged to contact the organising committee at <a href="mailto:aistats2026@gmail.com" target="_blank">aistats2026@gmail.com</a>. We will make every reasonable effort to work with affected authors to find an appropriate way forward.
...
1.  **Maximum length is 9 pages** (excluding acknowledgments, references, and optional appendix). Use the extra page to address reviewer feedback.
2.  Paper must be de-anonymized. Use `\usepackage[accepted]{aistats2026}`.
3.  Main paper & appendix must be in one PDF, *not exceeding 10MB in size. *
4.  The paper title must be in title case.
5.  Do not change the style file or spacing. Contact the Publications Chair for questions.
6.  Paper size must be in US Letter only.
7.  Use the fonts from the style file. Avoid Type 3 fonts ([info](https://www.ics.uci.edu/~chenli/pdf-font-types/index.html)).
8.  ALL CAPS section headings as per LaTeX templates.
9.  Citations in (Author, Year) format, e.g., (Cheesman, 1985), using \`natbib\` or equivalent.
10. Acknowledgments section (optional) must be before References.
11. References section title: “References” – consistent style is required.
12. Reproducibility checklist after References, titled “Checklist”.
13. Use colorblind-friendly figure colors ([guide](https://www.audioeye.com/post/8-ways-to-design-a-color-blind-friendly-website/)).
14. See [AISTATS 2026 Paper Pack](https://aistats.org/aistats2026/AISTATS2026PaperPack.zip) for examples.

### B) Copyright Form (Mandatory)

Download the PMLR copyright form from [here](http://proceedings.mlr.press/pmlr-license-agreement.pdf), fill it in, sign it, and submit it. One author can sign for all.
...
The final version will appear in the [PMLR proceedings](https://proceedings.mlr.press/). You will need to agree to JMLR’s publishing terms ([license agreement](http://proceedings.mlr.press/pmlr-license-agreement.pdf)).
...
*Updated March 14 (& 27), 2026: the script is updated to correctly handle margin checks. *

## Instructions for Poster Presentations

See [poster instructions](https://virtual.aistats.org/FAQ/PostersInstructions).
