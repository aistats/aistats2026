...
8.  Resolve any issues during the review process, e.g., by recruiting emergency reviewers, addressing concerns from both reviewers and authors, and/or raising concerns with Senior ACs and Program Chairs.
...
*Update January 6, 2025: *Paper final decision notifications date is updated to January 22, 2026 AoE.
...
1.  **Registrations on OpenReview**
    ...
    - Read and agree to abide by the [AISTATS code of conduct](/Conferences/2026/CodeOfConduct).
2.  **Paper bidding**
...
3.  **Reviewer assignment adjustments**
...
More tips: [this blog post](https://team-approx-bayes.github.io/blog/ACtips/).

## Use of Generative AI

Large language models (LLMs) cannot be used to write reviews or meta-reviews. Refer to the *Ethical Conduct for Peer Review* section in the [Reviewer Guidelines](https://virtual.aistats.org/Conferences/2026/ReviewerGuidelines) for the policy statement.

Authors may utilize LLMs (e.g., for grammar checking), but they are responsible for all content. LLMs cannot be authors. Refer to the *Use of Generative AI* section in the [Call for Papers](https://virtual.aistats.org/Conferences/2026/CallForPapers) for the policy statement.
...
The reviewers and ACs can be nominated via the following form: [Google Form](https://forms.gle/g2GNvYNU6B2fB5hR9)
